...
def main():
    ...
    #camera = WebcamVideoStream(src="rtsp://admin:gspe12345@192.168.0.23:554/PSIA/streaming/channels/301").start()
    ...
    while (loop):
        ...
        imgOriginalScene  = imutils.resize(frame, width = 850)
        ...
        if count == (VERIF-1):
            ...
            if (license[VERIF-1] == ""):
                ...
                elif (len(nums) >= 5 and len(nums) <= 9 and nums[0] >= 'A' and nums[0] <= 'Z' and numbers <= 4 and words <= 5):
